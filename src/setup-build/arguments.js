...
const optionsConfiguration = [
  {
    ...
    name: 'version', alias: 'v', defaultValue: defaults.version,
    description: 'Build version to setup: [8.2.0.0, 9.0.0.0, ...]',
  }, {
    name: 'build', alias: 'b', defaultValue: defaults.build,
...
const helpConfiguration = [
  { header: 'Download, extract and costumize your Pentaho build!' },
